...
const WhatsAppButton = () => {
  ...
  const whatsappNumber = "923001234567"; // Example: Pakistan number
  const message = "Hello! I'm interested in your Islamic products.";
  ...
  return (
    ...
    >
      ...
      {/* Tooltip */}
      <div className="absolute right-full mr-3 top-1/2 -translate-y-1/2 bg-gray-900 text-white px-4 py-2 rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap pointer-events-none">
